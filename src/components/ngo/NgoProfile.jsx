...
import { getNgoProfile, updateNgoProfile, getAvatarLetter } from '../../utils/profileManager';
import InputField from '../ui/InputField';
import Button from '../ui/Button';
import toast from 'react-hot-toast';

const NgoProfile = () => {
  const [profile, setProfile] = useState(getNgoProfile());
  ...
  const handleSave = () => {
    try {
      const updated = updateNgoProfile(editForm);
      setProfile(updated);
      setEditForm(updated);
      setIsEditing(false);
      setIsOpen(false);
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="flex-1 text-left">
          <p className="text-sm font-semibold text-secondary">{profile.ngoName}</p>
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="space-y-3 text-xs">
                <InputField
                  ...
                  onChange={(e) => setEditForm({ ...editForm, ngoName: e.target.value })}
